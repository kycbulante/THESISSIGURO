...
if (isset($_GET['refresh'])) {
  header("Location: adminATTENDANCErecords.php");
  exit(); 
}
...
$searchquery = "SELECT TIME_KEEPING.in_morning, TIME_KEEPING.out_afternoon, TIME_KEEPING.emp_id, TIME_KEEPING.timekeep_day, employees.* from employees, TIME_KEEPING  WHERE  employees.emp_id = TIME_KEEPING.emp_id ORDER BY time_keeping.emp_id ASC LIMIT $start_from, $results_perpage";
...
<style>
      ...
      <div class="select-container">
       ...
       <div class="select-container3">
        <h6 style="margin-top: 20px">Date</h6>
        <select name="month">
      ...
      <select name="year">
        ...
        <div class="select-container4">
          ...
          <div class="form-actions">
                ...
                <!-- <a href="generate_pdf.php" class="btn btn-primary">Print all</a> -->
                <a href="printattendancerecords.php?printAll" class="btn btn-info btn-mini" target="_blank" style="margin-top:5px"><span class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>
    <a href="printattendancerecords.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"  style="margin-top:5px"><span class="icon"><i class="icon-print"></i></span> Print Displayed Masterlist</a>
