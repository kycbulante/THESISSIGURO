...
<body>
  ...
  <div id="content">
    ...
    <span class="span6">
      <h3 style="margin-top: 30px">Overtimes</h3>
    </span>
                ...
                <tbody>
                  ...
                  while ($row1 = mysqli_fetch_array($search_result)):
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        <center><a href="OTApproval.php?id=<?php echo $row1['ot_ID']; ?>"
                            class="btn btn-info btn-mini"><span class="icon"><i class="icon-edit"></i></span> Review</a>
                        </center>
                      </td>
