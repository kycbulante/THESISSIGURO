...
if (isset($_GET['refresh'])) {
  header("Location: adminSSSLoans.php");
  exit(); 
}
...
<body>
  ...
  <div id="content">
    ...
    <span class="span6">
      <h3 style="margin-top: 30px">GSIS Loans</h3>
    </span>
                    ...
                    <form method="GET" action="">
                      ...
                      <div class="selections">
                        ...
                        <div class="select-container3">
                          ...
                          <h6 style="margin-top: 25px">Loan Status</h6>
                        ...
                        <div class="select-container4">
                          ...
                          <div class="row-fluid" style="margin-top:5px">
                            ...
                            <a href="printsss.php?printAll" class="btn btn-info btn-mini" target="_blank"><span
                                class="icon"><i class="icon-print"></i></span> Print All Masterlist</a>

                              <a href="printsss.php?printDisplayed" class="btn btn-info btn-mini" target="_blank"
                             ><span class="icon"><i class="icon-print"></i></span> Print
                              Displayed Masterlist</a>
                              <a href ="adminADDSSSLoan.php" class = "btn btn-info" style = "float:right; margin-left: 4px;"><span class="icon"><i class="icon-plus"></i></span> Add GSIS Loan</a>
                              </div>  
              ...
              <tbody>
                  ...
                  while ($row1DEPT = mysqli_fetch_array($searchresult)):
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        <?php echo $row1DEPT['start_date']; ?>
                      </td>
                      <td>
                        <?php echo $row1DEPT['end_date']; ?>
                      </td>
                      <td>
