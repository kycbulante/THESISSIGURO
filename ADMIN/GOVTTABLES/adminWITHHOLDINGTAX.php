                ...
                <div class="widget-box">
                  <div class="widget-title">
                    <ul class="nav nav-tabs" id="myTab">
                      ...
                      <li class="active"><a href="adminWITHHOLDINGTAX.php"><i class="icon-th"></i> Withholding Tax</a>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div id="tab1" class="tab-pane fade in active">
                      ...
                      <div class="row-fluid">
                        ...
                        <div class="container-fluid">
                          ...
                          <button type="submit" class="btn btn-success printbtn" name="print_btn">Refresh</button>
